...
def summarize_performance(step, g_model, latent_dim, n_samples=100):
    ...
    pyplot.savefig(osp.join(img_file, filename1))
    pyplot.close()
    # save the generator model
    filename2 = 'model_%04d.h5' % (step+1)
    g_model.save(osp.join(img_file, filename2))
...
checkpoint = tf.train.Checkpoint(discriminator=discriminator, generator=generator, gan=gan_model)
img_file = osp.join(osp.abspath(osp.dirname(__file__)), "imgs")
