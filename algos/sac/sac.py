...
from algos.sac.core import get_vars
...
class SAC:
    def __init__(self, env_name, port=2000, gpu=0, train_step=25000, evaluation_step=3000, max_ep_len=6000, alpha=0.2,
                 lr=1e-3, epsilon_train=0.1, polyak=0.995, start_steps=2000, batch_size=32, replay_size=100000,
                 iteration=200, gamma=0.99,
        ...
        with tf.variable_scope('main'):
            self.mu, self.pi, logp_pi, q1, q2, q1_pi, q2_pi, v = core.cnn(self.x_ph, self.a_ph)
        ...
        train_pi_op = pi_optimizer.minimize(self.pi_loss, var_list=get_vars('main/pi'))
        ...
        self.step_ops = [self.pi_loss, q1_loss, q2_loss, v_loss, q1, q2, v, logp_pi,
    ...
    def run_one_phrase(self, min_step, eval_mode=False):
        ...
        while step < min_step:
            ...
            self.saver.save(self.sess, os.path.join(savepath, "model" + str(episode%5)))
...
if __name__ == '__main__':
    ...
    sac = SAC(args.env, port=args.port, gpu=args.gpu, logger_kwargs=logger_kwargs)
    sac.train_test()
